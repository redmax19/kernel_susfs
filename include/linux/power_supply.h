...
enum power_supply_type {
	...
	POWER_SUPPLY_TYPE_USB_TYPE_C,		/* Type C Port (8) */
	POWER_SUPPLY_TYPE_USB_PD,		    /* Power Delivery Port (9) */
	POWER_SUPPLY_TYPE_USB_PD_DRP,		/* PD Dual Role Port (10) */
	POWER_SUPPLY_TYPE_APPLE_BRICK_ID,	/* Apple Charging Method (11) */
	POWER_SUPPLY_TYPE_BMS,				/* Battery Monitor System (12) */
	POWER_SUPPLY_TYPE_MISC,				/* 13 */
	POWER_SUPPLY_TYPE_WIRELESS,			/* 14 */
	POWER_SUPPLY_TYPE_HV_WIRELESS,			/* 15 */
	POWER_SUPPLY_TYPE_PMA_WIRELESS,			/* 16 */
	POWER_SUPPLY_TYPE_CARDOCK,			/* 17 */
	POWER_SUPPLY_TYPE_UARTOFF,			/* 18 */
	POWER_SUPPLY_TYPE_OTG,				/* 19 */
	POWER_SUPPLY_TYPE_LAN_HUB,			/* 20 */
	POWER_SUPPLY_TYPE_MHL_500,			/* 21 */
	POWER_SUPPLY_TYPE_MHL_900,			/* 22 */
	POWER_SUPPLY_TYPE_MHL_1500,			/* 23 */
	POWER_SUPPLY_TYPE_MHL_USB,			/* 24 */
	POWER_SUPPLY_TYPE_SMART_OTG,			/* 25 */
	POWER_SUPPLY_TYPE_SMART_NOTG,			/* 26 */
	POWER_SUPPLY_TYPE_POWER_SHARING,		/* power sharing cable(27) */
	POWER_SUPPLY_TYPE_HV_MAINS,			/* 28 */
	POWER_SUPPLY_TYPE_HV_MAINS_12V,			/* 29 */
	POWER_SUPPLY_TYPE_HV_PREPARE_MAINS,		/* 30 */
	POWER_SUPPLY_TYPE_HV_ERR,			/* 31 */
	POWER_SUPPLY_TYPE_MHL_USB_100,			/* 32 */
	POWER_SUPPLY_TYPE_MHL_2000,			/* 33 */
	POWER_SUPPLY_TYPE_HV_UNKNOWN,			/* 34 */
	POWER_SUPPLY_TYPE_MDOCK_TA,			/* Mdock charger(35) */
	POWER_SUPPLY_TYPE_HMT_CONNECTED,		/* 36 */
	POWER_SUPPLY_TYPE_HMT_CHARGE,			/* 37 */
	POWER_SUPPLY_TYPE_WIRELESS_PACK,		/* 38 */
	POWER_SUPPLY_TYPE_WIRELESS_PACK_TA,		/* 39 */
	POWER_SUPPLY_TYPE_WIRELESS_STAND,       /* 40 */
	POWER_SUPPLY_TYPE_WIRELESS_HV_STAND,    /* 41 */
	POWER_SUPPLY_TYPE_PDIC,				/* 42 */
	POWER_SUPPLY_TYPE_HV_MAINS_CHG_LIMIT,	/* 43 */
